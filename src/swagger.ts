...
const options: swaggerJsdoc.Options = {
  definition: {
    openapi: "3.0.0",
    info: {
      title: "Etstur Price Bot API",
      version: "1.0.0",
      description: "Etstur fiyat sorgulama ve otel eslestirme servisi",
    },
      ...
      schemas: {
        HotelMapping: {
          ...
          properties: {
            ...
            etsturHotelId: { type: "string" },
            destinationUrl: { type: "string", example: "Kemer-Otelleri" },
      ...
      "/api/prices": {
        get: {
          ...
          parameters: [
            ...
            { name: "checkIn", in: "query", required: true, schema: { type: "string" }, example: "2026-06-24" },
            { name: "checkOut", in: "query", required: true, schema: { type: "string" }, example: "2026-06-25" },
            ...
            { name: "childAges", in: "query", required: false, schema: { type: "string" }, description: "Virgulle ayrilmis cocuk yaslari, ornek: 5,8", example: "5" },
          ],
          responses: {
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    checkIn: { type: "string", example: "2026-06-24" },
                    checkOut: { type: "string", example: "2026-06-25" },
                    adults: { type: "integer", example: 2 },
                    children: { type: "integer", default: 0, example: 0 },
                    childAges: { type: "array", items: { type: "integer" }, example: [5] },
                  },
                },
              },
            },
          ...
          requestBody: {
            ...
            content: {
              "application/json": {
                schema: {
                  type: "object",
                  required: ["internalHotelId", "etsturHotelId", "destinationUrl"],
                  properties: {
                    internalHotelId: { type: "string", example: "hotel-99" },
                    etsturHotelId: { type: "string", example: "swr922thyt19" },
                    destinationUrl: { type: "string", example: "Kemer-Otelleri" },
                    hotelName: { type: "string", example: "Mirage Park Resort" },
                ...
                schema: {
                  ...
                  properties: {
                    mappings: {
                      ...
                      example: [
                        { internalHotelId: "hotel-10", etsturHotelId: "swr922thyt19", destinationUrl: "Kemer-Otelleri", hotelName: "Mirage Park Resort" },
                        { internalHotelId: "hotel-11", etsturHotelId: "swr012ayht19", destinationUrl: "Belek-Otelleri", hotelName: "Granada Luxury Belek" },
                      ],
                    },
                  },
                },
